...
class ImageDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 charset_path:str='/media/avlab/DATA/ABINet/workdir/CTE/abinet_dic2.txt',
    ...
    def get(self, idx):
        with self.env.begin(write=False) as txn:
            ...
            try:
                ...
                # label = re.sub('[^0-9\u4e00-\u9fff]+', '', label)
                # label = re.sub('[^0-9\w]', '', label)
                # label = re.sub('[丨丿]', '', label)
...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        text_x = re.sub('[^0-9\u4e00-\u9fff]+', '', text_x)
        text_x = re.sub('[^0-9\w]', '', text_x)
        text_x = re.sub('[丨丿]', '', text_x)
        ...
        text_y = re.sub('[^0-9\u4e00-\u9fff]+', '', text_y)
        # text_y = re.sub('[^0-9\w]', '', text_y)
        # text_y = re.sub('[丨丿]', '', text_y)
